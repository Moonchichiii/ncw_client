        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-20 pt-8 border-t border-border-main">
          ...
          <div className="md:col-span-7 flex flex-col md:flex-row items-start md:items-center justify-end gap-6">
            <button
              ...
              className="group relative overflow-hidden bg-text-strong text-bg-main px-8 py-4 text-sm font-bold uppercase tracking-widest hover:bg-text-accent hover:text-white transition-colors duration-300 w-full md:w-auto"
            >
