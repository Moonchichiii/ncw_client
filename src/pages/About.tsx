        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-border-main border border-border-main">
          ...
          <div className="md:col-span-2 industrial-card p-8 bg-bg-sub relative overflow-hidden group">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div className="space-y-6">
                ...
                <a href="/CV_EN.pdf" className="inline-flex items-center gap-4 text-text-main font-bold group/link mt-4">
          ...
          <div className="md:col-span-4 grid grid-cols-2 md:grid-cols-4 gap-px bg-border-main">
             ...
             <button 
                ...
                className="industrial-card p-6 text-center !bg-[#0044cc] !border-[#0044cc] text-white flex flex-col items-center justify-center group cursor-pointer hover:brightness-110 transition-all"
             >
